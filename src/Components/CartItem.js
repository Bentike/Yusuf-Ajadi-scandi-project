        ...
        <div className="cart-item">
          ...
          <div className="item-image-wrap">
            <div className="item-image">
              <button className="cart-btn" onClick={() => this.props.increaseItem(this.props.size, this.props.color, this.props.name)}>
                <span className="text">+</span>
              </button>
              <button className="quantity">
                <span className="text">{this.props.quantity}</span>
              </button>
              <button className="cart-btn" onClick={() => this.props.decreaseItem(this.props.size, this.props.color, this.props.name)}>
                <span className="text">-</span>
              </button>
            </div>
            <div>
